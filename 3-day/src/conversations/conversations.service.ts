...
export class ConversationsService {
  ...
  async sendMessage(
    id: number,
    text: string,
    params?: { stopSequence?: string[]; maxTokens?: number; n?: number; model?: string },
  ): Promise<{
    userMessage: Message;
    ...
    const choices = await this.aiService.chat(history, params, conversation.systemPrompt ?? undefined);
